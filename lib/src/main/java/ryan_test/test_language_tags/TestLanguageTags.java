...
import ryan_test.test_language_tags.utils.SpeakeasyHTTPClient;

public class TestLanguageTags {
	/**
	...
	public static class Builder {
		...
		public Builder setServerURL(String serverUrl, java.util.Map<String, String> params) {
			this.sdkConfiguration.serverUrl = ryan_test.test_language_tags.utils.Utils.templateUrl(serverUrl, params);
			return this;
		}
		 ...
		 */
		public TestLanguageTags build() throws Exception {
			...
			return new TestLanguageTags(this.sdkConfiguration);
		}
	}
	...
	private TestLanguageTags(SDKConfiguration sdkConfiguration) throws Exception {
